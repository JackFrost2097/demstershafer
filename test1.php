...
<div class="col-sm-11">
    <div class="row">
        <div class="col-md-6 col-lg-6 pt-5 mt-5 align-items-center justify-content-center text-center " id="home">
            <h1>Sistem Pakar Diagnosis Penyakit</h1>
            <h3>menemukan penyakit anda seperti ahlinya</h3>
            <h1>‎</h1>
            <button type="button" class="btn btn-primary">Cek Penyakit</button>
    ...
    <div class="row bodyy text-center">
        <h1>‎</h1>
        <h1 class="text-light">Jenis Penyakit Yang Dapat Kami Diagnosa</h1>
        <h3>‎</h3>
        <div class="container">
    ...
    <div
        class="cusbg imgdua text-primary fw-bolder thumbnaill d-flex align-items-center justify-content-center  pt-5 pb-5">
